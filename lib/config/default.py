...
_C.DATASET.DATAROOT = r'E:\chen\YOLOP-main\datasets\images'       # the path of images folder
_C.DATASET.LABELROOT = r'E:\chen\YOLOP-main\datasets\det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = r'E:\chen\YOLOP-main\datasets\da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = r'E:\chen\YOLOP-main\datasets\ll_seg_annotations'               # the path of ll_seg_annotations folder
...
_C.TRAIN.LR0 = 0.001  # initial learning rate (SGD=1E-2, Adam=1E-3)学习率
